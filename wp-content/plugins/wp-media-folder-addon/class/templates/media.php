...
<script src="<?php echo WPMFAD_PLUGIN_URL ?>/assets/js/mediaelement-and-player.js"></script>
<link rel="stylesheet" type="text/css" href="<?php echo WPMFAD_PLUGIN_URL ?>/assets/css/mediaelementplayer.min.css?v=<?php echo time() ?>">
<div id="wpfdViewer"> 
<?php if($mediaType=='image') { ?>
<img src="<?php echo $downloadLink;?>" alt="" title="" /> 
<?php } else if($mediaType=='video') { ?>
    <video  width="100%" height="100%" src="<?php echo $downloadLink;?>" type="<?php echo $mimetype;?>" class="mejs-player"  data-mejsoptions='{"alwaysShowControls": true}' 
           id="playerVid" controls="controls" preload="auto" autoplay="true">
        <source type="<?php echo $mimetype;?>" src="<?php echo $downloadLink;?>"/> 
         Your browser does not support the <code>video</code> element.
    </video>
<?php } else if($mediaType=='audio') { ?>
      <audio src="<?php echo $downloadLink;?>" type="<?php echo $mimetype;?>" 
