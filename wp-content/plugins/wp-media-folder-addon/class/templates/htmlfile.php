<div class="wpmfaddonfile entry file" data-id="<?php echo $id ?>" data-name="<?php echo $name ?>">
    <div class="entry_block">
        <div class="entry_edit">
            ...
            <a href="<?php echo $downloadlink ?>" title="<?php _e('Download file','wpmfAddon') ?>"><i data-id="<?php echo $id ?>" class="wpmfaddonicon-download zmdi zmdi-cloud-download"></i></a>
            
            <?php if(!empty($display_preview)): ?>
            <a class="wpmflinkfile <?php echo $type ?>" title="<?php echo $name ?>" data-link="<?php echo $downloadlink ?>" data-id="<?php echo $id ?>" href="<?php echo $lightboxlink ?>">
        ...
        <a class="entry_link" title="<?php echo $name ?>" data-filename="<?php echo $name ?>">
            <div class="entry_thumbnail">
                <div class="entry_thumbnail-view-bottom">
                    <div class="entry_thumbnail-view-center">
                        <a href="#">
                            <img class="imgthumb" data-id="<?php echo $id ?>" src="<?php echo $thumbnail ?>">
                        </a>
                    </div>
                </div>
            </div>
            <div class="entry_name">
                <div class="entry-name-view">
                    <span class="wpmf_filename" data-ext="<?php echo $infofile['extension'] ?>" data-name="<?php echo $infofile['filename'] ?>"><?php echo $name ?></span>
                </div>
            </div>
        </a>
    </div>
