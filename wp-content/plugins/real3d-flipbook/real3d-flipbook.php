...
<?php
	...
	*/
	...
	define('REAL3D_FLIPBOOK_VERSION', '2.18.8');
	function cup_code_load_plugin_textdomain() {
    load_plugin_textdomain( 'cup_code', FALSE, basename( dirname( __FILE__ ) ) . '/lang/' );
}
add_action( 'plugins_loaded', 'cup_code_load_plugin_textdomain' );
	function trace($var){
