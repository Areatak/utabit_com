    ...
    <div id='real3dflipbook-admin'>
        ...
        <form method="post" enctype="multipart/form-data" action="admin.php?page=real3d_flipbook_admin&action=save_settings&bookId=<?php echo($current_id);?>">
            <p class="submit">
                ...
                <input type="submit" name="submit" id="submit" class="button save-button button-primary" value="ذخیره تغییرات">
            ...
            <p>این افزونه بدست تارنمای <a href="http://cupcode.ir">کدفنجونی</a> آماده سازی شده است</p>
            <p>اگر درباره شیوه بکارگیری این افزونه پرسش یا درخواستی دارید می‌توانید از پیوند
            <a href="http://cupcode.ir/افزونه-وردپرس-نمایش-کتاب-real-3d-flipbook-نسخه-2-18-8-پار">افزونه Real 3D FlipBook</a>
            پیگیری کنید.
            </p>
            <div class="tabs">
                <ul>
                    <li>
                        <a href="#tab-pages">
                            <h4><?php _e('Pages','cup_code');?></h4>
                        </a>
                    </li>
                    <li>
                        <a href="#tab-general">
                            <h4><?php _e('General','cup_code');?></h4>
                        </a>
                    </li>
                    <li>
                        <a href="#tab-lightbox">
                            <h4><?php _e('Lightbox','cup_code');?></h4>
                        </a>
                    </li>
                    <li>
                        <a href="#tab-menu">
                            <h4><?php _e('Menu','cup_code');?></h4>
                        </a>
                    </li>
                    <li>
                        <a href="#tab-webgl">
                            <h4><?php _e('WebGL','cup_code');?></h4>
                        </a>
                    </li>
                    <li>
                        <a href="#tab-mobile">
                            <h4><?php _e('Mobile','cup_code');?></h4>
                        </a>
                    </li>
                    <li>
                </ul>
                <div id="tab-pages">
                    <div id="side-sortables" class="meta-box-sortables ui-sortable" style="">
                        ...
                        <h2><?php _e('Select flipbook type','cup_code');?></h2>
                        <p>
                            <label>
                                <input id="flipbook-type-pdf" name="type" type="radio" value="pdf"> <?php _e('PDF','cup_code');?>     
                            </label>
                        </p>
                        <p>
                            <label>
                                <input id="flipbook-type-jpg" name="type" type="radio" value="jpg"> <?php _e('JPG','cup_code');?>     
                            </label>
                        </p>
                        <div class="clear" />
                        <div id="select-pdf">
                        ...
                        <div id="add-jpg-pages" style="display:none;">
                            <h2><p><a class="page-title-action add-pages-button" href="#"><?php _e('Add pages','cup_code');?></a></p><p>
                            <a class="page-title-action select-pdf-button" href="#"><?php _e('Convert PDF to JPG-s','cup_code');?></a></p></h2>
                    ...
                    <div id="convert-pdf" style="display:none;"><?php _e('PDF','cup_code');?>
                        <a href="#" class="add-new-h2 select-pdf-button"><?php _e('Select','cup_code');?></a>
                    </div>
                </div>
                </div>
                <div id="tab-general">
                    ...
                    <div class="metabox-holder">
                        <div class="meta-box-sortables">
                            <div class="postbox closed">
                                ...
                                <h3 class="hndle"><?php _e('Current page','cup_code');?></h3>
                                <div class="inside">
                            ...
                            <div class="postbox closed">
                                <div class="handlediv" title="Click to toggle"></div>
                                <h3 class="hndle"><?php _e('Button next page','cup_code');?></h3>
                                <div class="inside">
                            ...
                            <div class="postbox closed">
                                <div class="handlediv" title="Click to toggle"></div>
                                <h3 class="hndle"><?php _e('Button last page','cup_code');?></h3>
                                <div class="inside">
                            ...
                            <div class="postbox closed">
                                <div class="handlediv" title="Click to toggle"></div>
                                <h3 class="hndle"><?php _e('Button previous page','cup_code');?></h3>
                                <div class="inside">
                            ...
                            <div class="postbox closed">
                                <div class="handlediv" title="Click to toggle"></div>
                                <h3 class="hndle"><?php _e('Button first page','cup_code');?></h3>
                                <div class="inside">
                            ...
                            <div class="postbox closed">
                                <div class="handlediv" title="Click to toggle"></div>
                                <h3 class="hndle"><?php _e('Button zoom in','cup_code');?></h3>
                                <div class="inside">
                            ...
                            <div class="postbox closed">
                                <div class="handlediv" title="Click to toggle"></div>
                                <h3 class="hndle"><?php _e('Button zoom out','cup_code');?></h3>
                                <div class="inside">
                            ...
                            <div class="postbox closed">
                                <div class="handlediv" title="Click to toggle"></div>
                                <h3 class="hndle"><?php _e('Button table of content','cup_code');?></h3>
                                <div class="inside">
                            ...
                            <div class="postbox closed">
                                <div class="handlediv" title="Click to toggle"></div>
                                <h3 class="hndle"><?php _e('Button thumbnails','cup_code');?></h3>
                                <div class="inside">
                            ...
                            <div class="postbox closed">
                                <div class="handlediv" title="Click to toggle"></div>
                                <h3 class="hndle"><?php _e('Button share','cup_code');?></h3>
                                <div class="inside">
                            ...
                            <div class="postbox closed">
                                <div class="handlediv" title="Click to toggle"></div>
                                <h3 class="hndle"><?php _e('Button download pages','cup_code');?></h3>
                                <div class="inside">
                            ...
                            <div class="postbox closed">
                                <div class="handlediv" title="Click to toggle"></div>
                                <h3 class="hndle"><?php _e('Button download PDF','cup_code');?></h3>
                                <div class="inside">
                            ...
                            <div class="postbox closed">
                                <div class="handlediv" title="Click to toggle"></div>
                                <h3 class="hndle"><?php _e('Button sound','cup_code');?></h3>
                                <div class="inside">
                            ...
                            <div class="postbox closed">
                                <div class="handlediv" title="Click to toggle"></div>
                                <h3 class="hndle"><?php _e('Button expand','cup_code');?></h3>
                                <div class="inside">
                            ...
                            <div class="postbox closed">
                                <div class="handlediv" title="Click to toggle"></div>
                                <h3 class="hndle"><?php _e('Button expand lightbox','cup_code');?></h3>
                                <div class="inside">
                            ...
                            <div class="postbox closed">
                                <div class="handlediv" title="Click to toggle"></div>
                                <h3 class="hndle"><?php _e('Button print','cup_code');?></h3>
                                <div class="inside">
            ...
            <p class="submit">
                <!-- <span class="unsaved" sytle="display:none;">Unsaved  </span> -->
                <input type="submit" name="submit" id="submit" class="button save-button button-primary" value="ذخیره تغییرات">
                <a href="#TB_inline?width=600&height=550&inlineId=flipbook-preview-container" class="thickbox flipbook-preview button save-button button-secondary"><?php _e('Preview Flipbook','cup_code');?></a>
            </p>
        </form>
    </div>
</div>
