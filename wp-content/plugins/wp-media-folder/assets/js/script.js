...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        wpmf_addFolder = function () {
            $('.wpmfaddFolder,.wpmf-attachment-create_folder').click(function () {
                showDialog({
                    title: wpmflang.create_folder,
                    text: '<input type="text" name="wpmf_newfolder_input" class="wpmf_newfolder_input" value="'+ wpmflang.new_folder +'">',
                    negative: {
                        title: wpmflang.cancel
                    },
                    positive: {
            ...
            if (wp.media && $('body.upload-php table.media').length === 0) {
                ...
                $(document).ajaxComplete(function (event, xhr, settings) {
                    if(typeof settings != "undefined" && typeof settings.data != "undefined"){
                        ...
                        if(typeof this_ajaxdata == 'string' && this_ajaxdata.indexOf('action=delete-post&id=') == 0){
                            if (wpmf_deleting) {
