<div class="content-box content-wpmf-media-access">
    <div class="cboption">
        <div class="wpmf_row_full">
            ...
            <label alt="<?php _e('This option gives the possibility to activate a media access limitation per user or per user role', 'wpmf'); ?>" class="text"><?php _e('Display only media by User/User role (admins will always have access to all/own media)', 'wpmf') ?></label>
            <div class="switch-optimization">
                <label class="switch switch-optimization">
                    <input type="checkbox" name="wpmf_active_media" id="cb_option_active_media" value="1" <?php if (isset($wpmf_active_media) && $wpmf_active_media == 1) echo 'checked' ?>>
                    <div class="slider round"></div>
                </label>
            </div>
        </div>
        <div class="wpmf_row_full">
            <label alt="<?php _e('Automatically create a folder per User or per WordPress User Role', 'wpmf'); ?>" class="text"><?php _e('Folder automatic creation', 'wpmf') ?></label>
        ...
        <div class="wpmf_row_full">
            ...
            <label alt="<?php _e('Apply single file design with below parameters when insert file to post / page', 'wpmf'); ?>" class="text"><?php _e('Enable single file design', 'wpmf') ?></label>
            <div class="switch-optimization">
                <label class="switch switch-optimization">
                    <input type="checkbox" name="wpmf_option_singlefile" value="1" <?php if (isset($option_singlefile) && $option_singlefile == 1) echo 'checked' ?>>
                    <div class="slider round"></div>
                </label>
            </div>
        </div>
    ...
    <div class="cboption">
        <div class="wpmf_row_full">
            ...
            <label alt="<?php _e('Add a lightbox option on each image of your WordPress content', 'wpmf'); ?>" class="text"><?php _e('Enable the single image lightbox feature', 'wpmf') ?></label>
            <div class="switch-optimization">
                <label class="switch switch-optimization">
                    <input type="checkbox" name="wpmf_option_lightboximage" id="cb_option_lightboximage" value="1" <?php if (isset($option_lightboximage) && $option_lightboximage == 1) echo 'checked' ?>>
                    <div class="slider round"></div>
                </label>
            </div>
        </div>
